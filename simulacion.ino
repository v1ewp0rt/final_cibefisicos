...
void estado_lcd(int estado) {
    ...
    // Si pasaron 10 minutos desde la ultima medición o nunca se midió
    if (tiempoActual-ultimaMedicion > 600000) {
    ...
    // Si pasaron 4 dias sin ventilar (abrir la compostera) se advierte
    if (tiempoActual-ultimaVentilacion>=345600000) { estado_lcd(2); }
